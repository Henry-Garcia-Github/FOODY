...
const restaurants = [
  ...
  },
  {
    name: "Papadum Indian",
    description:
      "Chez Papadum, nous souhaitons vous faire voyager dans ce pays avec notre cuisine d'inspiration indienne.",
  ...
  },
  {
    name: "Le Bureau",
    description:
      "Au Bureau rythme votre journée du matin jusqu'au soir : repas entre amis, apéro, sport, musique, danse… vous allez aimer passer du temps Au Bureau !",
  ...
  const foundedRestaurants = restaurants.filter(
    (restaurant) =>
      ...
      restaurant.typeOfFood.some((food) =>
        food.toLowerCase().includes(filter)
      ) ||
